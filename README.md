...
**Built with:** Next.js, TypeScript, Prisma, PostgreSQL, Docker
...
**Built with:** OpenAI API, Google Apps Script, Gmail, Google Sheets
...
**Built with:** Python, PyTorch, YOLO, SLURM, Computer Vision
